...
const Services = [
    // Servizi di design
    {
      ...
      planos: {
        plano1: { 
          nome: 'Design logo', 
          destaque: ["5 Disegni diversi", "Fino a 3 Revisioni", "Palette color", "1 Branding finale", "Formato: PNG, PDF, CDR, AI, PS", "Consegna entro 5 giorni"], 
          tags: ['design', 'logo', 'branding'],
          price: 60 ,
        }
      }
    },
    {
      ...
      planos: {
        plano1: { 
          nome: 'Pacchetto Base', 
          destaque: ['Sito funzionale', 'Fino a 5 Pagine', 'Caricamento del contenuto','Formulario di contato', 'Social icons', 'Configurazione dominio e hosting', 'Fino a 3 Revisioni', 'Consegna in 5 giorni'], 
          price: 122,
        },
        plano2: { 
          nome: 'Pacchetto Silver', 
          destaque: ['Sito funzionale', 'Fino a 10 Pagine', 'Caricamento del contenuto', 'Formulario di contato', 'Social icons', 'Catalogo prodotti/servizi', 'Checkout con whatsapp', 'Configurazione dominio e hosting', 'Fino a 4 Revisioni', 'Consegna in 7 giorni'], 
          price: 315
        },
        plano3: { 
          nome: 'Pacchetto Premium', 
          destaque: ['Sito funzionale', 'Pagine ilimitate', 'Caricamento del contenuto', 'Formulario di contato', 'Social icons', 'Catalogo prodotti/servizi', 'Checkout con whatsapp', 'Configurazione dominio e hosting', 'Configurazione Chatbot', 'Revisioni ilimitate', 'Consulenza Online (12h/anno)', 'Consegna in 7 giorni'],
          price: 1082
        },
      },
    },
